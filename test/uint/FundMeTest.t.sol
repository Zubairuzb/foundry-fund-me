...
contract FundMeTest is Test {
    ...
    function testWithdrawWithAsingleFunder() public {
        ...
        uint256 totalGas = (gasStart - gasEnd) * tx.gasprice;
    ...
    function testWithdrawFromMultipleFunders() public {
        ...
        uint256 startingOwnerBalance = fundMe.getOwner().balance;
        uint256 startingFunMeBalance = address(fundMe).balance;
        ...
        assert(
            startingFunMeBalance + startingOwnerBalance ==
                fundMe.getOwner().balance
        );
    }

    //test cheaper withdraw function
